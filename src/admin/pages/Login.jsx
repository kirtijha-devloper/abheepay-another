...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    // For now, simply navigate to the admin dashboard
    navigate('/admin');
  };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center mb-6">
          <div className="text-4xl font-bold text-cyan-400 italic">a<span className="text-gray-800 text-3xl font-semibold not-italic">bheePay</span></div>
        </div>
